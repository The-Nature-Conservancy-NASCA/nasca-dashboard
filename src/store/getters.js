export default {
  ...
  aliados: (state, getters, rootState) => {
    const features =
      rootState.filtro.modo === "estrategia"
        ? getters.aliadosPorEstrategia(rootState.filtro.valor)
        : rootState.filtro.modo === "proyecto"
        ? getters.aliadosPorProyectos([rootState.filtro.valor])
        : rootState.aliados;
